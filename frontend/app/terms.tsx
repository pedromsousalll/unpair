          ...
          <VStack space="lg" padding="$4">
            ...
            <VStack space="md">
              ...
              <Text color={colors.text}>
                By accessing and using KICKS, you accept and agree to be bound by the terms and provision of this agreement.
              </Text>

              <Heading size="md" color={colors.text}>2. Use License</Heading>
              <Text color={colors.text}>
                Permission is granted to temporarily use KICKS for personal, non-commercial purposes. This is the grant of a license, not a transfer of title.
              </Text>
              ...
              <Text color={colors.text}>
                KICKS is a marketplace platform. We do not own, sell, or control the items listed. Users are solely responsible for the accuracy of their listings and for completing transactions.
              </Text>

              <Heading size="md" color={colors.text}>6. Intellectual Property</Heading>
              <Text color={colors.text}>
                The service and its original content, features, and functionality are owned by KICKS and are protected by international copyright, trademark, and other intellectual property laws.
              </Text>

              <Heading size="md" color={colors.text}>7. Disclaimer</Heading>
              <Text color={colors.text}>
                KICKS is provided on an "as is" and "as available" basis. We make no warranties, expressed or implied, and hereby disclaim all warranties.
              </Text>

              <Heading size="md" color={colors.text}>8. Limitation of Liability</Heading>
              <Text color={colors.text}>
                In no event shall KICKS, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages.
              </Text>
